...
def get_urls_for_new_building():
    ...
    for page in range(1, get_num_new_building() + 1):
        ...
        if page == 1:
            response = scraper.get(f"https://dom.ria.com/uk/novostroyki/{city}/?isChangeRadius=true")
        else:
            response = scraper.get(f"https://dom.ria.com/uk/novostroyki/{city}/?isChangeRadius=true&page={page}")
